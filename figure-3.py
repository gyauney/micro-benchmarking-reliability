...
for benchmark in benchmarks:
    ...
    df_mde.loc[(df_mde['Split'] == 'seen') & (df_mde['Number of source models'] == num_source_models)].to_csv(f'{save_dir}/figure-3_{num_source_models}-source-models_{benchmark}-mdad.csv', index=False)
